            ...
            <!--header start here-->
				<div class="header-main">
					<div class="header-left">
							<div class="logo-name">
									 <a href="userhome.jsp"> <h1>EquipFarm</h1> 
...
<div class="inner-block">
    <div class="product-block">
    	...
    	<option value="tractor">tractor</option>
   		 <option value="favarani">favarani</option>
   		 <option value="cultivitar">cultivitar</option>
   		  <option value="tilar">tilar</option>
    	...
    	<% while(rs.next()){ 
    		...
    		float hourprice = rs.getFloat(4);
    		float dayprice = rs.getFloat(5);
        ...
        <div class="col-md-4 product-grid">
    		<div class="product-items">
	    		    <div class="project-eff">
						<div id="nivo-lightbox-demo"> <p> <a href="data:image/jpeg;base64, <%= row.getImage() %>"data-lightbox-gallery="gallery1" id="nivo-lightbox-demo"><span class="rollover1"> </span> </a></p></div>     
							<img class="img-responsive" src="data:image/jpeg;base64, <%= row.getImage() %>" alt="">
					</div>
	    		<div class="produ-cost">
                   ...
                   <a href="viewequipment.jsp?id=<%= row.getEid() %>&dis=<%= row.getDistance() %>"><button class="btn btn-default">view</button></a> 
	    		</div>
    		</div>
    	</div>
             <% } %>
